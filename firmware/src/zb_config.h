...
#define	ZDO_NWK_SCAN_ATTEMPTS						3	// Fortify: 3 scans per (re)join so distant repeaters are heard
...
#define	ZDO_MAX_PARENT_THRESHOLD_RETRY				3	// Fortify: declare parent lost sooner -> re-home faster
