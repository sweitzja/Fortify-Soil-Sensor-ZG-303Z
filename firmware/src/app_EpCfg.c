...
const zclAttrInfo_t illuminanceMeasure_attrTbl[] = {
    { ZCL_ATTRID_MEASURED_VALUE,          ZCL_DATA_TYPE_UINT16, ACCESS_CONTROL_READ | ACCESS_CONTROL_REPORTABLE, (u8*)&g_zcl_illuminanceAttrs.measuredVal},
...
const zclAttrInfo_t ilsc_attrTbl[] = {
    { ZCL_ATTRID_ILSC_LEVEL_STATUS,       ZCL_DATA_TYPE_ENUM8,  ACCESS_CONTROL_READ | ACCESS_CONTROL_REPORTABLE, (u8*)&g_zcl_illuminanceAttrs.levelStatus},
#ifdef ZCL_ATTR_LIGHT_SENSOR_TYPE_ENABLE
...
#define ZCL_ILSC_ATTR_NUM  (sizeof(ilsc_attrTbl) / sizeof(zclAttrInfo_t))
...
const zclAttrInfo_t relative_humdity_attrTbl2[] =
{
	...
	{ 0xF000,	ZCL_DATA_TYPE_UINT16,	ACCESS_CONTROL_READ | ACCESS_CONTROL_REPORTABLE, (u8*)&g_zcl_MoistureAttrs.raw_adc },
	{ 0xF001,	ZCL_DATA_TYPE_UINT16,	ACCESS_CONTROL_READ | ACCESS_CONTROL_REPORTABLE, (u8*)&g_zcl_MoistureAttrs.adc_diode },
...
#if USE_SENSOR_XBR818
	.thres	= DEF_OCCUPANCY_THRES
#endif
};
/* Attribute record list */
const zclAttrInfo_t occupancy_attrTbl[] = {
	{ ZCL_ATTRID_OCCUPANCY,  ZCL_DATA_TYPE_BITMAP8,   ACCESS_CONTROL_READ | ACCESS_CONTROL_REPORTABLE,  (u8*)&zcl_occupAttr.occupancy},
...
//	{ ZCL_ATTRID_PIR_UNOCCU2OCCU_DELAY,  ZCL_DATA_TYPE_UINT16,   ACCESS_CONTROL_READ | ACCESS_CONTROL_WRITE,  (u8*)&zcl_occupAttr.oc2un_delay},
#if USE_SENSOR_XBR818
	{ ZCL_ATTRID_PIR_UNOCCU2OCCU_THRES,  ZCL_DATA_TYPE_UINT8,   ACCESS_CONTROL_READ | ACCESS_CONTROL_WRITE,  (u8*)&zcl_occupAttr.thres},
#endif
	{ ZCL_ATTRID_GLOBAL_CLUSTER_REVISION, ZCL_DATA_TYPE_UINT16,  ACCESS_CONTROL_READ,  (u8*)&zcl_attr_global_clusterRevision},
};
